...
export const processSteps = [
  {
    step: 1,
    title: "Inspection",
    description: "We thoroughly assess the surfaces to determine the appropriate cleaning method and solutions."
  },
  {
    step: 2,
    title: "Preparation",
    description: "We protect surrounding areas, plants, and fixtures to prevent any potential damage."
  },
  {
    step: 3,
    title: "Application",
    description: "We apply the appropriate cleaning solutions and use the right pressure for optimal results."
  },
  {
    step: 4,
    title: "Final Inspection",
    description: "We review our work to ensure everything meets our high standards of quality."
  }
];
